...
fn write_faces_x(
    ...
    for (var n = 2u; n > 0; n--) {
        ...
        minus_x_vertices((1u ^ face_dir) * v_index, temp_uv, x_f32, y_f32, z_f32);
...
fn write_faces_y(
    ...
    for (var n = 2u; n > 0; n--) {
        ...
        minus_y_vertices((1u ^ face_dir) * v_index, temp_uv, x_f32, y_f32, z_f32);
        (*index_count) += 6u * draw_face;
        (*vertex_count) += 4u * draw_face;
    }
}
...
fn write_faces_z(
    ...
    for (var n = 2u; n > 0; n--) {
        ...
        minus_z_vertices((1u ^ face_dir) * v_index, temp_uv, x_f32, y_f32, z_f32);
        (*index_count) += 6u * draw_face;
        (*vertex_count) += 4u * draw_face;
    }
}

fn mesh_chunk_position(blocks: ptr<storage, ChunkBlocks>, x: u32, y: u32, z: u32) {
