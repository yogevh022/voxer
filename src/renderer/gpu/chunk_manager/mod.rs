...
use crate::world::types::{CHUNK_DIM, ChunkRelevantBlocks, PACKED_CHUNK_DIM};
...
impl<const NUM_BUFFERS: usize> StagingBufferMapping<NUM_BUFFERS> {
    ...
    pub fn push_to_staging(
        ...
        for i in 0..self.targets.len() {
            ...
            let slab_index = chunk_allocations.insert(chunk_rel.chunk.position, mesh_alloc);
