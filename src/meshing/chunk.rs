...
use glam::{Vec2, Vec3};
const X_VERTICES_BY_DIR: [fn(&mut Vec<Vertex>, Vec2, f32, f32, f32, f32); 2] = [minus_x_vertices, plus_x_vertices];
const Y_VERTICES_BY_DIR: [fn(&mut Vec<Vertex>, Vec2, f32, f32, f32, f32); 2] = [minus_y_vertices, plus_y_vertices];
const Z_VERTICES_BY_DIR: [fn(&mut Vec<Vertex>, Vec2, f32, f32, f32, f32); 2] = [minus_z_vertices, plus_z_vertices];
    ...
    for i in 0..chunk_faces.x.faces.len() {
        ...
        for z in 0..CHUNK_SIZE {
            ...
            if (chunk_faces.z.faces[i] & (1 << z)) != 0 {
                ...
                Z_VERTICES_BY_DIR[face_dir_bit](&mut vertices, z_uv, x, y, z as f32, texture_atlas.tile_dim);
            }
        }
    }
